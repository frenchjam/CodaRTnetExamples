...
namespace codaRTNet
{
	class HWConfigOptionsCX1Ports : public HWConfigOptions
	{
	public:
		HWConfigOptionsCX1Ports(::DWORD dwConfigAddress)
		{
			...
			dev.base.wOptionID = CODANET_HWCONFIGOPTIONID_CX1PORTS;
		}
		...
		{ codanet_hwconfig_cx1ports_ntoh((CODANET_HWCONFIG_CX1PORTS*)data); }

		virtual void hton(void* data) const
		{ codanet_hwconfig_cx1ports_hton((CODANET_HWCONFIG_CX1PORTS*)data); }

	public:
		CODANET_HWCONFIG_CX1PORTS dev;
	};
}
